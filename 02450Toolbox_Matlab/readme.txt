...
/Tools/Apriori
The apriori algorithm is taken from http://www.borgelt.net/apriori.html, for
details of the algorithm see also http://www.borgelt.net/doc/apriori/apriori.

/Tools/nc_multiclass
/Tools/nr
These neural network tools are taken from http://cogsys.imm.dtu.dk/toolbox/ann/
the scripts nr_eval.m and nc_eval.m have been added to the toolbox.

/Tools/TMG_5.OR6
Text to Matrix Generator (TMG) software availabe at http://scgroup20.ceid.upatras.gr:8000/tmg

/Data:
Contains the data examples used:
